    ...
    <div>
      <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto">
        ...
        <div className="flex items-center justify-end space-x-4">
          {/* homeIcon */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="navBtn">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="navBtn -rotate-90">
            <path strokeLinecap="round" strokeLinejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5" />
          </svg>
          <div className="absolute -top-1 -right-2 text-sx w-5 h-5 bg-red-500 rounded-full flex items-center justify-center animate-pulse text-white">3</div>
          </div>
          ...
          <img src="https://avatars.githubusercontent.com/u/97034683?v=4" alt="picture" className="h-10 w-10 rounded-full cursor-pointer"/>
